...
def fastamap(multifasta, filesize):
    """
...
def fastafind(d, input, output):
    """
    :param d: dictionary
    :param input: file handler with AC to find in the dictionary
    :param output: file handler (write mode) of output
    :return: None
    """
    for line in input:
        key = line.rstrip
